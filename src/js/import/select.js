...
$(document).ready(function (){
	...
	const selectSingle2_title = selectSingle2.querySelector('.select-c1--title');
	const selectSingle2_labels = selectSingle2.querySelectorAll('.select-c1--label');
	...
	$(document).click( function(e){
		const selectSingle2 = document.querySelector('.select-c1');
		const selectSingle2_title = $( ".select-c1--title" );
